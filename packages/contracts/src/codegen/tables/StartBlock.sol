...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("StartBlock")));
bytes32 constant StartBlockTableId = _tableId;
