...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("MatchIndex")));
bytes32 constant MatchIndexTableId = _tableId;
