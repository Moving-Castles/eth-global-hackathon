...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("CoresPerBody")));
bytes32 constant CoresPerBodyTableId = _tableId;

library CoresPerBody {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CoresPerBody", _fieldNames);
  }
