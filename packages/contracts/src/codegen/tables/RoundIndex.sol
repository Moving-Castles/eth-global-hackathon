...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("RoundIndex")));
bytes32 constant RoundIndexTableId = _tableId;
