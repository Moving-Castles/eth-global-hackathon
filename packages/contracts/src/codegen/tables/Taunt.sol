...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("moving_castles"), bytes16("Taunt")));
bytes32 constant TauntTableId = _tableId;
...
library Taunt {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "taunter";
    return ("Taunt", _fieldNames);
  }
  ...
  function encode(bytes32 taunter) internal view returns (bytes memory) {
    return abi.encodePacked(taunter);
  }
